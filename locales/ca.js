...
window.CLASSE_LOCALES.ca = {
  ...
  room_clear: 'Treure les taules',
  room_clear_title: 'Treu totes les taules de l\'alumnat; el mobiliari i la llista d\'alumnat es mantenen',
  confirm_room_clear: 'Treure totes les taules de l\'alumnat? El mobiliari i la llista d\'alumnat es mantenen. Es pot desfer.',
  ...
  teams_room_overflow: 'Els equips no caben amb folgança en una aula d\'aquestes mides: s\'han col·locat a dins, però amb menys espai del recomanat entre les taules o fins a les parets. Convé ampliar l\'aula o canviar la mida dels equips.',
