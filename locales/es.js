...
window.CLASSE_LOCALES.es = {
  ...
  about_link: 'Qué es AulaMap',
  about_title: 'Para qué sirve el programa y qué permite hacer',
  class_label: 'Clase',
  ...
  room_clear: 'Quitar las mesas',
  room_clear_title: 'Quita todas las mesas del alumnado; el mobiliario y la lista de alumnado se mantienen',
  confirm_room_clear: '¿Quitar todas las mesas del alumnado? El mobiliario y la lista de alumnado se mantienen. Se puede deshacer.',
  ...
  teams_room_overflow: 'Los equipos no caben con holgura en un aula de estas medidas: se han colocado dentro, pero con menos espacio del recomendado entre las mesas o hasta las paredes. Conviene ampliar el aula o cambiar el tamaño de los equipos.',
